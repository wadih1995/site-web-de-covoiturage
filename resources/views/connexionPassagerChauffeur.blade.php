...
<body>
    ...
    <div class="container">
        ...
        <div class="card w-75">
            <div class="card-body">
              <h1 class="card-title">connexion passager</h1>
              <a href="{{ route('user.login') }}" class="btn btn-primary">cliquer ici</a>
            </div>
          </div>
          </div>
          <div class="col-12 ">
            <div class="card w-75">
                <div class="card-body">
                  <h1 class="card-title">connexion chauffeur</h1>
                  <a href="{{ route('chauffeur.login') }}" class="btn btn-primary">cliquer ici</a>
                </div>
              </div>
              </div>
          </div>
