...
<body>
    ...
    <header class="jumbotron login-chauffeur">
        <div class="container ">
            ...
            <div class="row align-items-center offset-4">
                <h2>bienvenue les chauffeurs !</h2>
            </div>
        </div>
    </header>
    ...
    <div class="container">
        <div class="card mb-3">
            <img class="card-img-top" src="img/chauffeur.png" width="200px" height="300px" alt="Card image cap">
            <div class="card-body">
              ...
              pour créer votre compte chauffeur et commencer à gagner de l'argent 
              </p>
              <a href="{{ route('chauffeur.register') }}"  class="btn btn-secondary">inscrivez vous</a><br>
              ...
              <a href="{{ route('chauffeur.login') }}" class="btn btn-secondary">connectez vous</a>
            </div>
          </div>
    </div>

    <footer class="footer login-chauffeur">
        <div class="container">
            <div class="row">            
